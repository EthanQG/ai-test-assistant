...
20. 阶段2.16.2：已建立5份脱敏合成图文样本、schema v1金标准，以及正文、表格和OCR最小评分Runner；视觉语义评分尚未实现
21. 阶段2.16.3～2.16.6：完成RAG、Reviewer和三方案实验
22. 阶段2.17：只有前述阶段稳定后，再评估FastAPI、后台任务、SSE和Vue
